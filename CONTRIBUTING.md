...
First off, thank you for considering contributing to **LocalPDF**! Your help makes this project better for everyone.
...
Before we can accept your contributions, you must sign our Contributor License Agreement (CLA). This is required because LocalPDF uses a dual licensing model:
...
If you are contributing on behalf of your employer, your organization needs to sign our [Corporate Contributor License Agreement (CCLA)](CCLA.md). Please contact us at [contact@localpdf.org](mailto:contact@localpdf.org) to arrange corporate CLA signing.
...
**Email:** [contact@localpdf.org](mailto:contact@localpdf.org)
...
Thank you for helping make **LocalPDF** a better library for everyone!
