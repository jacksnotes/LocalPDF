/*
 * coherentpdf.global.d.ts — TypeScript type definitions for LocalPDF / CoherentPDF integration
 *
 * These type definitions were written by Alam for use in the LocalPDF project.
